...
# slope <-
#   read_stars(here::here("data/slope_tm32.tif")) |>
#   st_transform(crs = st_crs(konstanz))
# 
# bbox <- st_bbox(konstanz)
# slope <- st_crop(slope, bbox)
```
...
```{r}
ggplot() +
  geom_sf(konstanz, mapping = aes(), color = "lightgrey", fill = "#f2f2f2") +
